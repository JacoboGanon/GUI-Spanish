...
class FrontEnd:
    ...
    def admin_ask_password(self):
        ...
        self.password_entry = Entry(font=20, self.frame1_admin_password, show='*')
    ...
    def inventory_list(self):
        ...
        for product_information in self.complete_products_data:
            ...
            self.listbox_of_products.insert(counter, product_information[0])
        self.listbox_of_products.place(relx=0.05, rely=.1, relwidth=0.9, relheight=0.8)
        self.add_inventory_entry = Entry(font=20, self.frame4_admin_page, justify='center')
    ...
    def add_product_to_sell(self):
        ...
        self.item_to_sell_entry = Entry(font=20, self.frame3_admin_page)
        ...
        self.price_entry = Entry(font=20, self.frame4_admin_page)
        ...
        self.current_inventory_entry = Entry(font=20, self.frame5_admin_page)
        self.current_inventory_entry.place(relx=0.15, rely=0.08, relwidth=0.7, relheight=0.3)
        self.cost_entry = Entry(font=20, self.frame6_admin_page)
    ...
    def add_activity(self):
        ...
        self.add_activity_entry = Entry(font=20, self.frame1_activity_page)
    ...
    def check_activity(self):
        ...
        self.time_schedule_entry = Entry(font=20, self.frame3_class_page, fg='grey')
        ...
        self.teacher_entry = Entry(font=20, self.frame4_class_page)
        ...
        self.available_seats_entry = Entry(font=20, self.frame5_class_page)
    ...
    def add_student(self):
        ...
        self.user_id_entry = Entry(font=20, self.frame2_add_student)
        ...
        self.user_name_entry = Entry(font=20, self.frame3_add_student)
        ...
        self.user_birthday_entry = Entry(font=20, self.frame4_add_student)
        ...
        self.parent_address_entry = Entry(font=20, self.frame5_add_student)
        ...
        self.parent_phone_entry = Entry(font=20, self.frame6_add_student)
        ...
        self.parent_email_entry = Entry(font=20, self.frame7_add_student)
        ...
        self.father_name_entry = Entry(font=20, self.frame8_add_student)
        ...
        self.mother_name_entry = Entry(font=20, self.frame9_add_student)
        ...
        self.inscription_date_entry = Entry(font=20, self.frame10_add_student)
        ...
        self.payment_day_entry = Entry(font=20, self.frame11_add_student)
        ...
        self.amount_paid_entry = Entry(font=20, self.frame12_add_student)
        ...
        self.hours_of_access_entry = Entry(font=20, self.frame13_add_student)
